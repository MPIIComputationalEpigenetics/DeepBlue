...
namespace epidb {
  namespace engine {
    ...
    public:
      ...
      bool process_histogram(const std::string &query_id, const std::string& column_name, const int bars, const std::string &user_key, processing::StatusPtr status, mongo::BSONObj& result);
