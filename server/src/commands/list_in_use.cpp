...
namespace epidb {
  namespace command {
    ...
    private:
      ...
      {
        return CommandDescription(categories::GENERAL_INFORMATION, "Lists all terms from the given controlled vocabulary that have at least one Experiment or Annotation using them.");
      }
