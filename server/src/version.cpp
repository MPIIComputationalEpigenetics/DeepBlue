...
namespace epidb {
  ...
  const std::string Version::copyright = "Copyright Copyright (c) 2013,2014 Max Planck Institute for Computer Science. All rights reserved.";
  const std::string Version::author = "Felipe Albrecht - felipe.albrecht@mpi-inf.mpg.de";
  const std::string Version::coauthors = "Fabian Reinartz";
  const size_t Version::major_version = 0;
  const size_t Version::minor_version = 9;
  const size_t Version::fix_version = 66;
}
