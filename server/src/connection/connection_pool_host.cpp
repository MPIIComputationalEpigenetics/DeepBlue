...
#include "connection_pool_host.hpp"
...
namespace epidb {
  ...
  MongoHostConnectionPool::MongoHostConnectionPool(
    const MongoHostConnectionPool &other) :
    m_minValidCreationTimeMicroSec(other.m_minValidCreationTimeMicroSec)
    , m_Created(other.m_Created)
    , m_MaxPoolSize(other.m_MaxPoolSize)
    , m_ConnString(other.m_ConnString)
  {
  }
