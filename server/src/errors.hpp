...
namespace epidb {
  ...
  extern Error ERR_USER_MOTIF_MISSING;
  ...
  extern Error ERR_DUPLICATED_GENE_ONTOLOGY_TERM_ID;
  extern Error ERR_DUPLICATED_GENE_ONTOLOGY_TERM_LABEL;
  extern Error ERR_INVALID_GENE_ONTOLOGY_TERM_ID;
  extern Error ERR_INVALID_GENE_ONTOLOGY_NAMESPACE;
  extern Error ERR_ALREADY_CONECTED_GENE_ONTOLOGY_TERM;
  ...
  extern Error ERR_INVALID_UNIVERSE_ID;
