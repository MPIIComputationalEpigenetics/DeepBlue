...
namespace epidb {
  namespace dba {
    ...
    private:
      ...
      bool gene_gtf_attributes(const std::string &op, const std::string &chrom, const mongo::BSONObj &obj, const AbstractRegion *region_ref, processing::StatusPtr status, std::string &result, std::string &msg);
