...
namespace epidb {
  ...
  namespace processing {
    ...
    bool histogram(const std::string& query_id, const std::string& column_name, const int bars, const std::string& user_key, const processing::StatusPtr status, mongo::BSONArray& counts, std::string& msg);
