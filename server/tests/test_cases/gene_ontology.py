...
class TestGenes(helpers.TestCase):
  ...
  def test_gene_retrieve(self):
    ...
    #print epidb.list_genes(["ENSG00000238009.*", "ENSG00000239945.*", "ENSG00000239906.*"], None, None, None, "Test One", self.admin_key)
    print epidb.list_genes("ENSG00000239906.1", "chr1", 0, 1000000, "Test One", self.admin_key)