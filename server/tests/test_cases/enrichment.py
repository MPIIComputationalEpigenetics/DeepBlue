...
class TestEnrichment(helpers.TestCase):
    ...
    def test_enriochment_overlap(self):
      ...
      self.assertEquals(result, {'enrichment': {'count_query_regions': 3074, 'count_universe_regions': 313669, 'results': [{'c': 0, 'b': 30195, 'description': '', 'p_value_log': float('Inf'), 'experiment_size': 33270, 'database_name': 'H3k4me3', 'max_rank': 1, 'support_rank': 1, 'dataset': 'wgEncodeBroadHistoneH1hescH3k4me3StdPk.bed', 'biosource': 'K562', 'odd_rank': 1, 'odds_ratio': float('Inf'), 'epigenetic_mark': 'H3k4me3', 'mean_rank': 1.0, 'log_rank': 1, 'support': 3074, 'd': 280400}]}})
      ...
      self.assertEquals({'enrichment': {'count_query_regions': 1, 'count_universe_regions': 313669, 'results': [{'c': 1, 'b': 33269, 'description': '', 'p_value_log': 0.0, 'experiment_size': 33270, 'database_name': 'H3k4me3', 'max_rank': 1, 'support_rank': 1, 'dataset': 'wgEncodeBroadHistoneH1hescH3k4me3StdPk.bed', 'biosource': 'K562', 'odd_rank': 1, 'odds_ratio': 0.0, 'epigenetic_mark': 'H3k4me3', 'mean_rank': 1.0, 'log_rank': 1, 'support': 0, 'd': 280399}]}}, result)
