...
class TestTilingRegions(helpers.TestCase):
  ...
  def test_metacolumn_experiment_name(self):
    ...
    self.assertEqual(regions, "Unable to find the column 'experiment_name' in the dataset format or in the DeepBlue columns.")
    ...
    self.assertFailure(res, regions)
    self.assertEqual(regions, "Unable to find the column 'experiment_name:string:' in the dataset format or in the DeepBlue columns.")
