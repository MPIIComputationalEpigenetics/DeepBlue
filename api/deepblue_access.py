...
class DeepBlueClient(object):
    ...
    def list_genes(self, gene_id_or_name=None, go_terms=None, chromosome=None, start=None, end=None, gene_models=None, user_key=deepblue_USER_KEY):
        return self.server.list_genes(gene_id_or_name=None, go_terms=None, chromosome=None, start=None, end=None, gene_models=None, user_key=deepblue_USER_KEY)
    ...
    def select_genes(self, genes_name=None, go_terms=None, gene_model=None, chromosome=None, start=None, end=None, user_key=deepblue_USER_KEY):
        return self.server.select_genes(genes_name=None, go_terms=None, gene_model=None, chromosome=None, start=None, end=None, user_key=deepblue_USER_KEY)
